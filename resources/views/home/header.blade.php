       ...
       <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <div class="row">
                      <i class="bi bi-cart-check-fill ml-3"></i>
                      <a class="nav-link ml-0 pl-0" href="{{url('show_cart')}}">Cart</a>
                  </div>
                </li>
               ...
               @if (Route::has('login'))
                  ...
                  @else
                  <li class="nav-item">
                     <a class="btn btn-outline-primary  ml-2 mr-3" href="{{ route('login') }}">Login</a>
                  </li>
                  <li class="nav-item">
